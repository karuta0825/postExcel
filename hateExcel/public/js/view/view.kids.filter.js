...
(function ( $, cms ) {
  ...
  , elements = {
      ...
      special: {
        'wrap' : '.special .filter-item__body',
        'btn': '.btn--son',
      },
    }
  , _search
  ...
  _selectSpecial = function () {

    if (view.get('special__btn').hasClass('btn--on')) {
      view.get('special__btn').removeClass('btn--on');
      customer.model.kids.setCondition(
        { 'is_marked' : 'all' },
        cms.view.kids.drawTable ,
      );
    } else {
      view.get('special__btn').addClass('btn--on');
      customer.model.kids.setCondition(
        { is_marked : '1' },
        cms.view.kids.drawTable,
      );
  ...
  initModule = function () {
    ...
    view.addListener({
      ...
      'click special__btn'  : _selectSpecial,
    });
